...
import com.marolix.aromafood.RestOpenActivity;
...
public class RestListAdapter extends RecyclerView.Adapter<RestListAdapter.MyViewHolder> {
    ...
    public RestListAdapter(Context productActivity, String[] product_name, String[] prod_price, int[] images, ClickListener clickListener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.rest_vert_list_item, viewGroup, false);
...
//        myViewHolder.quantity.setText("1");
       ...
       myViewHolder.prod_image.setImageResource(images[i]);
        ...
        myViewHolder. card_rest_list_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, RestOpenActivity.class);
//intent.putExtra("bitmap", (Parcelable) prod_image);
                intent.putExtra("POSITION", String.valueOf(i));
                intent.putExtra("Position1",String.valueOf(i));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        CardView card_rest_list_layout;
        int sum;

        public MyViewHolder(@NonNull View itemView, final ClickListener listener) {
            super(itemView);

            card_rest_list_layout = itemView.findViewById(R.id.card_rest_list_layout);
            ...
            /*card_rest_list_layout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    context.startActivity(new Intent(context, ProductActivity.class));
                }
