...
import com.marolix.aromafood.fragments.FragZomatoUI;
...
public class NavDrawerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.frame_container, new FragZomatoUI()).commit();
...
//                        Toast.makeText(MainActivity.this, "Permission Granted", Toast.LENGTH_LONG).show();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        String cate1 = Utilities.getPreference(NavDrawerActivity.this, Constants.CATEGORY_1);
        String cate2 = Utilities.getPreference(NavDrawerActivity.this, Constants.CATEGORY_2);
        String cate3= Utilities.getPreference(NavDrawerActivity.this, Constants.CATEGORY_3);

        adapter.addFrag(new FragZomatoUI(), cate1);
        adapter.addFrag(new FragFoodCourt(), cate2);
